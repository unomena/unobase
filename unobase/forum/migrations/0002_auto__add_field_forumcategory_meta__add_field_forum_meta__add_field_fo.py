...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ForumCategory.meta'
        db.add_column(u'forum_forumcategory', 'meta',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Forum.meta'
        db.add_column(u'forum_forum', 'meta',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ForumThread.meta'
        db.add_column(u'forum_forumthread', 'meta',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ForumPost.meta'
        db.add_column(u'forum_forumpost', 'meta',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ForumCategory.meta'
        db.delete_column(u'forum_forumcategory', 'meta')

        # Deleting field 'Forum.meta'
        db.delete_column(u'forum_forum', 'meta')

        # Deleting field 'ForumThread.meta'
        db.delete_column(u'forum_forumthread', 'meta')

        # Deleting field 'ForumPost.meta'
        db.delete_column(u'forum_forumpost', 'meta')
