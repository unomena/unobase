...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'corporate_site_product', ['slug'])

        # Removing unique constraint on 'Article', fields ['slug']
        db.delete_unique(u'corporate_site_article', ['slug'])

        # Removing unique constraint on 'Vacancy', fields ['slug']
        db.delete_unique(u'corporate_site_vacancy', ['slug'])

        # Removing unique constraint on 'CompanyMember', fields ['slug']
        db.delete_unique(u'corporate_site_companymember', ['slug'])


    def backwards(self, orm):
        # Adding unique constraint on 'CompanyMember', fields ['slug']
        db.create_unique(u'corporate_site_companymember', ['slug'])

        # Adding unique constraint on 'Vacancy', fields ['slug']
        db.create_unique(u'corporate_site_vacancy', ['slug'])

        # Adding unique constraint on 'Article', fields ['slug']
        db.create_unique(u'corporate_site_article', ['slug'])

        # Adding unique constraint on 'Product', fields ['slug']
        db.create_unique(u'corporate_site_product', ['slug'])
