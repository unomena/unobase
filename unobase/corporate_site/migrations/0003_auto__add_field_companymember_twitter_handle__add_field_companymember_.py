...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyMember.twitter_handle'
        db.add_column(u'corporate_site_companymember', 'twitter_handle',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompanyMember.linked_in_handle'
        db.add_column(u'corporate_site_companymember', 'linked_in_handle',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompanyMember.facebook_handle'
        db.add_column(u'corporate_site_companymember', 'facebook_handle',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyMember.twitter_handle'
        db.delete_column(u'corporate_site_companymember', 'twitter_handle')

        # Deleting field 'CompanyMember.linked_in_handle'
        db.delete_column(u'corporate_site_companymember', 'linked_in_handle')

        # Deleting field 'CompanyMember.facebook_handle'
        db.delete_column(u'corporate_site_companymember', 'facebook_handle')
