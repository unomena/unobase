...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Article.relatedmodel_ptr'
        db.delete_column(u'corporate_site_article', u'relatedmodel_ptr_id')

        # Deleting field 'Event.relatedmodel_ptr'
        db.delete_column(u'corporate_site_event', u'relatedmodel_ptr_id')

        # Deleting field 'Product.relatedmodel_ptr'
        db.delete_column(u'corporate_site_product', u'relatedmodel_ptr_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Article.relatedmodel_ptr'
        raise RuntimeError("Cannot reverse this migration. 'Article.relatedmodel_ptr' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Article.relatedmodel_ptr'
        db.add_column(u'corporate_site_article', u'relatedmodel_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['unobase.RelatedModel'], unique=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Event.relatedmodel_ptr'
        raise RuntimeError("Cannot reverse this migration. 'Event.relatedmodel_ptr' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Event.relatedmodel_ptr'
        db.add_column(u'corporate_site_event', u'relatedmodel_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['unobase.RelatedModel'], unique=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Product.relatedmodel_ptr'
        raise RuntimeError("Cannot reverse this migration. 'Product.relatedmodel_ptr' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Product.relatedmodel_ptr'
        db.add_column(u'corporate_site_product', u'relatedmodel_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['unobase.RelatedModel'], unique=True),
                      keep_default=False)
