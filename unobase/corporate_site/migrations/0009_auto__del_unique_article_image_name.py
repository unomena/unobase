...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Article', fields ['image_name']
        db.delete_unique(u'corporate_site_article', ['image_name'])


    def backwards(self, orm):
        # Adding unique constraint on 'Article', fields ['image_name']
        db.create_unique(u'corporate_site_article', ['image_name'])
