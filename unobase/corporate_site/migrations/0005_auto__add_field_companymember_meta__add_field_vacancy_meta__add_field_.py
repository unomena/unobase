...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyMember.meta'
        db.add_column(u'corporate_site_companymember', 'meta',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Vacancy.meta'
        db.add_column(u'corporate_site_vacancy', 'meta',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Article.meta'
        db.add_column(u'corporate_site_article', 'meta',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.meta'
        db.add_column(u'corporate_site_product', 'meta',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyMember.meta'
        db.delete_column(u'corporate_site_companymember', 'meta')

        # Deleting field 'Vacancy.meta'
        db.delete_column(u'corporate_site_vacancy', 'meta')

        # Deleting field 'Article.meta'
        db.delete_column(u'corporate_site_article', 'meta')

        # Deleting field 'Product.meta'
        db.delete_column(u'corporate_site_product', 'meta')
