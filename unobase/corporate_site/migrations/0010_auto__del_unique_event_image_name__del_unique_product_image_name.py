...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Product', fields ['image_name']
        db.delete_unique(u'corporate_site_product', ['image_name'])

        # Removing unique constraint on 'Event', fields ['image_name']
        db.delete_unique(u'corporate_site_event', ['image_name'])


    def backwards(self, orm):
        # Adding unique constraint on 'Event', fields ['image_name']
        db.create_unique(u'corporate_site_event', ['image_name'])

        # Adding unique constraint on 'Product', fields ['image_name']
        db.create_unique(u'corporate_site_product', ['image_name'])
