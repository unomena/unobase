...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'CompanyMember', fields ['image_name']
        db.delete_unique(u'corporate_site_companymember', ['image_name'])


        # Changing field 'CompanyMember.content'
        db.alter_column(u'corporate_site_companymember', 'content', self.gf('unobase.fields.RedactorTextField')(null=True))

        # Changing field 'Vacancy.content'
        db.alter_column(u'corporate_site_vacancy', 'content', self.gf('unobase.fields.RedactorTextField')(null=True))

        # Changing field 'Article.content'
        db.alter_column(u'corporate_site_article', 'content', self.gf('unobase.fields.RedactorTextField')(null=True))

        # Changing field 'Product.content'
        db.alter_column(u'corporate_site_product', 'content', self.gf('unobase.fields.RedactorTextField')(null=True))

    def backwards(self, orm):

        # Changing field 'CompanyMember.content'
        db.alter_column(u'corporate_site_companymember', 'content', self.gf('ckeditor.fields.RichTextField')(null=True))
        # Adding unique constraint on 'CompanyMember', fields ['image_name']
        db.create_unique(u'corporate_site_companymember', ['image_name'])


        # Changing field 'Vacancy.content'
        db.alter_column(u'corporate_site_vacancy', 'content', self.gf('ckeditor.fields.RichTextField')(null=True))

        # Changing field 'Article.content'
        db.alter_column(u'corporate_site_article', 'content', self.gf('ckeditor.fields.RichTextField')(null=True))

        # Changing field 'Product.content'
        db.alter_column(u'corporate_site_product', 'content', self.gf('ckeditor.fields.RichTextField')(null=True))

    models = {
        u'calendar.event': {
            'Meta': {'ordering': "('start',)", 'object_name': 'Event'},
            u'auditmodel_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['unobase.AuditModel']", 'unique': 'True'}),
            'content': ('unobase.fields.RedactorTextField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'zone_code': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '6'})
        },
        u'calendar.venue': {
            'Meta': {'ordering': "['name', 'address']", 'object_name': 'Venue'},
        ...
        u'corporate_site.event': {
            'Meta': {'ordering': "['-start']", 'object_name': 'Event', '_ormbases': [u'calendar.Event']},
