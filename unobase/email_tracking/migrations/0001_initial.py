...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'email_tracking_outboundemail', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='inbound_emails', null=True, to=orm['user.User'])),
        ...
        db.send_create_signal(u'email_tracking', ['OutboundEmail'])


    def backwards(self, orm):
        # Deleting model 'OutboundEmail'
        db.delete_table(u'email_tracking_outboundemail')
    ...
    models = {
        ...
        u'email_tracking.outboundemail': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'inbound_emails'", 'null': 'True', 'to': u"orm['user.User']"})
        },
        u'eula.eula': {
