...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Calendar.meta'
        db.add_column(u'calendar_calendar', 'meta',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.meta'
        db.add_column(u'calendar_event', 'meta',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Calendar.meta'
        db.delete_column(u'calendar_calendar', 'meta')

        # Deleting field 'Event.meta'
        db.delete_column(u'calendar_event', 'meta')
