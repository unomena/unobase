...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'blog_blog', (
            ...
            ('effect', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='blog_related', null=True, to=orm['photologue.PhotoEffect'])),
        ...
        m2m_table_name = db.shorten_name(u'blog_blog_sites')
        ...
        db.create_table(u'blog_blogentry', (
            ...
            ('view_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('crop_from', self.gf('django.db.models.fields.CharField')(default='center', max_length=10, blank=True)),
            ('effect', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='blogentry_related', null=True, to=orm['photologue.PhotoEffect'])),
            ('state', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('publish_date_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('retract_date_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ...
            ('posted_on_behalf_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='blog_entries_posted_on_behalf', null=True, to=orm['user.User'])),
            ('co_authored_by', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'blog', ['BlogEntry'])

        # Adding M2M table for field sites on 'BlogEntry'
        m2m_table_name = db.shorten_name(u'blog_blogentry_sites')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('blogentry', models.ForeignKey(orm[u'blog.blogentry'], null=False)),
            ('site', models.ForeignKey(orm[u'sites.site'], null=False))
        ))
        db.create_unique(m2m_table_name, ['blogentry_id', 'site_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'blog_blog_sites'))

        # Deleting model 'BlogEntry'
        db.delete_table(u'blog_blogentry')

        # Removing M2M table for field sites on 'BlogEntry'
        db.delete_table(db.shorten_name(u'blog_blogentry_sites'))
