...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ContentBlock.tagmodel_ptr'
        db.delete_column(u'unobase_contentblock', u'tagmodel_ptr_id')


        # Changing field 'ContentBlock.auditmodel_ptr'
        db.alter_column(u'unobase_contentblock', u'auditmodel_ptr_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['unobase.AuditModel'], unique=True, primary_key=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ContentBlock.tagmodel_ptr'
        raise RuntimeError("Cannot reverse this migration. 'ContentBlock.tagmodel_ptr' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ContentBlock.tagmodel_ptr'
        db.add_column(u'unobase_contentblock', u'tagmodel_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['unobase.TagModel'], unique=True, primary_key=True),
                      keep_default=False)


        # Changing field 'ContentBlock.auditmodel_ptr'
        db.alter_column(u'unobase_contentblock', u'auditmodel_ptr_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['unobase.AuditModel'], unique=True))
    ...
    models = {
        ...
        u'unobase.contentblock': {
            ...
            u'auditmodel_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['unobase.AuditModel']", 'unique': 'True', 'primary_key': 'True'}),
