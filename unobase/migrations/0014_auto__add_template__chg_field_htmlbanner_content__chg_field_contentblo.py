...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'unobase_template', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('path', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'unobase', ['Template'])


        # Changing field 'HTMLBanner.content'
        db.alter_column(u'unobase_htmlbanner', 'content', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'unobase_template')


        # Changing field 'HTMLBanner.content'
        db.alter_column(u'unobase_htmlbanner', 'content', self.gf('ckeditor.fields.RichTextField')(null=True))

        # Changing field 'ContentBlock.content'
        db.alter_column(u'unobase_contentblock', 'content', self.gf('ckeditor.fields.RichTextField')(null=True))
