...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'unobase_relatedmodel_related', (
        ...
        db.create_unique(u'unobase_relatedmodel_related', ['from_relatedmodel_id', 'to_relatedmodel_id'])
        ...
        db.create_table(u'unobase_contentblock_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('contentblock', models.ForeignKey(orm[u'unobase.contentblock'], null=False)),
            ('site', models.ForeignKey(orm[u'sites.site'], null=False))
        ))
        db.create_unique(u'unobase_contentblock_sites', ['contentblock_id', 'site_id'])
        ...
        db.create_table(u'unobase_imagebannerset_banners', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
        ...
        db.create_unique(u'unobase_imagebannerset_banners', ['imagebannerset_id', 'imagebanner_id'])
        ...
        db.create_table(u'unobase_htmlbannerset_banners', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
        ...
        db.create_unique(u'unobase_htmlbannerset_banners', ['htmlbannerset_id', 'htmlbanner_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('unobase_contentblock_sites')
