...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'ContentBlock', fields ['slug']
        db.delete_unique(u'unobase_contentblock', ['slug'])


    def backwards(self, orm):
        # Adding unique constraint on 'ContentBlock', fields ['slug']
        db.create_unique(u'unobase_contentblock', ['slug'])
