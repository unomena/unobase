...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AuditModel.modified_by'
        db.delete_column(u'unobase_auditmodel', 'modified_by_id')

        # Deleting field 'AuditModel.created_by'
        db.delete_column(u'unobase_auditmodel', 'created_by_id')


    def backwards(self, orm):
        # Adding field 'AuditModel.modified_by'
        db.add_column(u'unobase_auditmodel', 'modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='modified_objects', null=True, to=orm['user.User'], blank=True),
                      keep_default=False)

        # Adding field 'AuditModel.created_by'
        db.add_column(u'unobase_auditmodel', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='created_objects', null=True, to=orm['user.User'], blank=True),
                      keep_default=False)
