...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContentBlock.tagmodel_ptr'
        db.add_column(u'unobase_contentblock', u'tagmodel_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['unobase.TagModel'], unique=True, primary_key=True),
                      keep_default=False)
