...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'unobase_versionseries', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50)),
        ))
        db.send_create_signal(u'unobase', ['VersionSeries'])

        # Adding model 'Version'
        db.create_table(u'unobase_version', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('series', self.gf('django.db.models.fields.related.ForeignKey')(related_name='versions', to=orm['unobase.VersionSeries'])),
            ('number', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('state', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
        ))
        db.send_create_signal(u'unobase', ['Version'])


    def backwards(self, orm):
        # Deleting model 'VersionSeries'
        db.delete_table(u'unobase_versionseries')

        # Deleting model 'Version'
        db.delete_table(u'unobase_version')
