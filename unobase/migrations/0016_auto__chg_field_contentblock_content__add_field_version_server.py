...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ContentBlock.content'
        db.alter_column(u'unobase_contentblock', 'content', self.gf('unobase.fields.RedactorTextField')(null=True))
        # Adding field 'Version.server'
        db.add_column(u'unobase_version', 'server',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ContentBlock.content'
        db.alter_column(u'unobase_contentblock', 'content', self.gf('django.db.models.fields.TextField')(null=True))
        # Deleting field 'Version.server'
        db.delete_column(u'unobase_version', 'server')
    ...
    models = {
        ...
        u'unobase.template': {
            ...
            'num_contents': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
            'num_images': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
        ...
        u'unobase.version': {
            ...
            'series': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'versions'", 'to': u"orm['unobase.VersionSeries']"}),
            'server': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '2'}),
            'state': ('django.db.models.fields.PositiveSmallIntegerField', [], {})
        },
        u'unobase.versionseries': {
