...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HTMLBanner.site'
        db.delete_column(u'unobase_htmlbanner', 'site_id')

        # Adding M2M table for field sites on 'HTMLBanner'
        db.create_table(u'unobase_htmlbanner_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('htmlbanner', models.ForeignKey(orm[u'unobase.htmlbanner'], null=False)),
            ('site', models.ForeignKey(orm[u'sites.site'], null=False))
        ))
        db.create_unique(u'unobase_htmlbanner_sites', ['htmlbanner_id', 'site_id'])

        # Adding M2M table for field sites on 'ImageBanner'
        db.create_table(u'unobase_imagebanner_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('imagebanner', models.ForeignKey(orm[u'unobase.imagebanner'], null=False)),
            ('site', models.ForeignKey(orm[u'sites.site'], null=False))
        ))
        db.create_unique(u'unobase_imagebanner_sites', ['imagebanner_id', 'site_id'])


    def backwards(self, orm):
        # Adding field 'HTMLBanner.site'
        db.add_column(u'unobase_htmlbanner', 'site',
        ...
        db.delete_table('unobase_htmlbanner_sites')

        # Removing M2M table for field sites on 'ImageBanner'
        db.delete_table('unobase_imagebanner_sites')
