...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VersionSeries.slug'
        db.alter_column(u'unobase_versionseries', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'VersionSeries.slug'
        db.alter_column(u'unobase_versionseries', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))
