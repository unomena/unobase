...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VersionSeries.staged_slug'
        db.add_column(u'unobase_versionseries', 'staged_slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VersionSeries.staged_slug'
        db.delete_column(u'unobase_versionseries', 'staged_slug')
