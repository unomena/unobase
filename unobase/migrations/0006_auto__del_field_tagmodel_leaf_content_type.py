...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TagModel.leaf_content_type'
        db.delete_column(u'unobase_tagmodel', 'leaf_content_type_id')


    def backwards(self, orm):
        # Adding field 'TagModel.leaf_content_type'
        db.add_column(u'unobase_tagmodel', 'leaf_content_type',
